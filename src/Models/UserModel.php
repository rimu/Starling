...
class UserModel
{
    ...
    public static function toMasto(array $u, ?string $viewerId = null, bool $includePrivate = false, int $_depth = 0): array
    {
        ...
        $out = [
            ...
            'uri'             => $actorUrl,
            'avatar'          => local_media_url_or_fallback($u['avatar'] ?? '', '/img/avatar.png'),
            'avatar_static'   => local_media_url_or_fallback($u['avatar'] ?? '', '/img/avatar.png'),
            'header'          => local_media_url_or_fallback($u['header'] ?? '', '/img/header.png'),
            'header_static'   => local_media_url_or_fallback($u['header'] ?? '', '/img/header.png'),
    ...
    public static function remoteToMasto(array $a, int $_depth = 0): array
    {
        ...
        return [
            ...
            'url'             => ($a['url'] ?? '') ?: $a['id'],
            'uri'             => $a['id'],
            'avatar'          => $a['avatar']     ?: $base . '/img/avatar.png',
            'avatar_static'   => $a['avatar']     ?: $base . '/img/avatar.png',
            'header'          => $a['header_img'] ?: $base . '/img/header.png',
            'header_static'   => $a['header_img'] ?: $base . '/img/header.png',
